...
export function HabitsList({ date, onCompletedChanged }: HabitsListProps) {
    ...
    async function handleToggleHabit(habitId: string) {
        ...
        const isHabitAlreadyCompleted = habitsInfo!.completedHabits.includes(habitId) // o ! é pra dizer pro TS confiar que vai sim chegar info no habitsInfo, portanto não será undefined
